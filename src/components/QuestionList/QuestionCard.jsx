    ...
    <>
    {
      questionPicked === 0 ?
        ...
        <div className='rounded-sm text-center h-full drop-shadow-lg'>
            <button className='text-yellow-500 hover:text-yellow-400 h-full w-full border-y-2 border-y-black ' onClick={clickQuestion}>
              <h1 className='font-black text-xl md:text-2xl lg:text-4xl xl:text-6xl drop-shadow-lg'>${props.question.difficulty}</h1>
            </button>   
        </div>
      :
      questionPicked === 1 ?
